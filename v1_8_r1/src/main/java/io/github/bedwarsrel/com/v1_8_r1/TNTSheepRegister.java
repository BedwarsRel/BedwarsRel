...
public class TNTSheepRegister implements ITNTSheepRegister {
  ...
  public void registerEntities(int entityId) {
    try {
      ...
      c_map.put("io.github.bedwarsrel.com.v1_8_r1.TNTSheep", TNTSheep.class);

      Field d = entityTypeClass.getDeclaredField("d");
      d.setAccessible(true);
      HashMap d_map = (HashMap) d.get(null);
      d_map.put(TNTSheep.class, "io.github.bedwarsrel.com.v1_8_r1.TNTSheep");
      ...
      g_map.put("io.github.bedwarsrel.com.v1_8_r1.TNTSheep", Integer.valueOf(entityId));
