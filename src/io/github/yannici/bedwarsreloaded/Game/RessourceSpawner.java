...
public class RessourceSpawner implements Runnable, ConfigurationSerializable {
    ...
    public RessourceSpawner(Game game, int interval, Location location, ItemStack itemstack) {
        this.game = game;
    ...
    @Override
    public void run() {
        this.game.getRegion().getWorld().dropItemNaturally(this.location, this.itemstack);
    }
