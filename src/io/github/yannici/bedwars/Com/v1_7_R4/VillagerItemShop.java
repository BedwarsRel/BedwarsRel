    ...
    public void openTrading() {
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                for(io.github.yannici.bedwars.Villager.VillagerTrade trade : VillagerItemShop.this.category.getOffers()) {
                ...
                ((CraftPlayer)player).getHandle().openTrade(entityVillager, VillagerItemShop.this.category.getName());
