        ...
        Main.getInstance().getServer().getScheduler().runTask(Main.getInstance(), new Runnable() {
            ...
            public void run() {
             // remove all player holograms on this location
                for(Entry<Player, List<Hologram>> entry : Main.getInstance().getHolographicInteractor().getHolograms().entrySet()) {
                ...
                Location holoLocation = HolographicDisplaysInteraction.this.getHologramLocationByLocation(holo.getLocation());
