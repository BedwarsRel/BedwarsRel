...
public class MerchantRecipe {
    ...
    public MerchantRecipe(Object item1, Object item2, Object reward) {
        ...
        try {
            this.instance = this.merchantRecipe.getDeclaredConstructor(isClass, isClass, isClass).newInstance(item1, item2, reward);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public Object getItem1() {
        try
        {
          Method m = this.merchantRecipe.getDeclaredMethod("getBuyItem1", new Class[0]);
    ...
    public Object getItem2() {
        try
        {
          Method m = this.merchantRecipe.getDeclaredMethod("getBuyItem2", new Class[0]);
          m.setAccessible(true);
          return m.invoke(this.merchantRecipe, new Object[0]);
        }
        catch (Exception e)
    ...
    public Object getRewardItem() {
        try
        {
          Method m = this.merchantRecipe.getDeclaredMethod("getBuyItem3", new Class[0]);
          m.setAccessible(true);
          return m.invoke(this.merchantRecipe, new Object[0]);
        }
        catch (Exception e)
