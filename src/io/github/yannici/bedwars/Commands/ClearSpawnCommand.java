...
public class ClearSpawnCommand extends BaseCommand implements ICommand {

	public ClearSpawnCommand(Main plugin) {
		super(plugin);
	}
	...
	public String getName() {
		return Main._l("commands.clearspawn.name");
	}

	@Override
	public String getDescription() {
		return Main._l("commands.clearspawn.desc");
	}
